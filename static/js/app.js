...
function getBathValue() {
  ...
  function onClickedEstimatePrice() {
    ...
    var url = "http://bangalore-property-prediction/predict_home_price"; //posting to server endpoint which will estimate the price for us
  ...
  function onPageLoad() {
    ...
    var url = "http://bangalore-property-prediction/get_location_names"; //fetching the location data from server endpoint which supplies us with the location names on requesting it
